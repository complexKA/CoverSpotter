...
int main( int argc, char *argv[] )  {
    ...
    QCoreApplication::setApplicationName( "CoverSpotter" );
    ...
    a.setWindowIcon( QIcon(":/Images/CoverSpotter-Logo.png") );     // Set an icon for Cinnamon
    ...
    QSharedMemory sharedMemory( "KA-CoverSpotter-050689310890" );
